...
const AvatarFallback = React.forwardRef(({ className, ...props }, ref) => (<AvatarPrimitive.Fallback ref={ref} className={cn('flex h-full w-full select-none items-center justify-center rounded-full bg-muted', className)} {...props}/>));
